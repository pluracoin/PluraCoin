...
namespace CryptoNote {
  ...
  struct IP2pEndpoint {
    ...
    virtual bool ban_host(const uint32_t address_ip, time_t seconds = CryptoNote::P2P_IP_BLOCKTIME, bool silent = true) = 0;
    virtual bool unban_host(const uint32_t address_ip, bool silent = true) = 0;
  ...
  struct p2p_endpoint_stub: public IP2pEndpoint {
    ...
    virtual bool ban_host(const uint32_t address_ip, time_t seconds, bool silent = true) override { return true; }
    virtual bool unban_host(const uint32_t address_ip, bool silent = true) override { return true; }
